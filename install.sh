...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY     qin            [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "Qinn" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Gih Ke Qin${NC}"
    echo -e "${YELLOW}TELEGRAM : @anjlwh${NC}"
    echo -e "${YELLOW}WHATSAPP : 6283125321220${NC}"
...
while true; do
  ...
  echo -e "${BLUE}'ggg      ,gg'''  .    ggg       Auto Installer  Qin      ${NC}"
  echo -e "${BLUE}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${BLUE}ggg:     gg.     -   ,ggg       • Telegram : @anjlwh      ${NC}"
  echo -e "${BLUE} ggg:     ggg._    _,ggg        • Creadit  : Qin          ${NC}"
  echo -e "${BLUE} ggg.    '.'''ggggggp           • Support by Qin          ${NC}"
